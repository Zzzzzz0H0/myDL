...
image_dir = '/home/zhuheng/workspace/myDL/CV/week8/LaneSeg/Image'
label_dir = '/home/zhuheng/workspace/myDL/CV/week8/LaneSeg/Label'
"""
   Image/
     road02/
       Record002/
...
print("The length of image dataset is {}, and label is {}".format(
...
train_dataset.to_csv(
    '/home/zhuheng/workspace/myDL/CV/week8/Lane_Segmentation_pytorch/data_list/train.csv',
    index=False)
val_dataset.to_csv(
    '/home/zhuheng/workspace/myDL/CV/week8/Lane_Segmentation_pytorch/data_list/val.csv',
    index=False)
test_dataset.to_csv(
    '/home/zhuheng/workspace/myDL/CV/week8/Lane_Segmentation_pytorch/data_list/test.csv',
    index=False)
